	...
	render() {
		return (
			<div className = "story">
				...
				Buzz and Charlotte Chapman opened their first rock shop in 1950, 
				...
				collection in either of the first two shops.
				<p className="line_break"></p>
				When it became evident that the highway 101 was to bypass Miranda, 
				they relocated to their present location in 1963, building the current sales 
				room to house both the museum collection and the retail business.
				<p className="line_break"></p>
				A second wing was added in 1985, at which time both the sales room and the 
				museum were expanded.
				<p className="line_break"></p>
				Together Buzz and Charlotte worked to build their business.Over the years, 
				Buzz worked in the woods, drove laundry truck, peeled tan bark, ran a split yard, 
				and in the latter years became a masonry contractor while Charlotte ran the business.
				<p className="line_break"></p>
				Buzz and Charlotte worked side-by-side both collecting and finishing stones. 
				...
				<p className="line_break"></p>
				How it still continues:
				<p className="line_break"></p>
				In 2001 Chapman's Gem and Mineral Shop switched hands to Buzz and Charlotte's daughter Sharon 
				...
				in order and running smoothly. They hope to open an additional museum displays in the near future.
